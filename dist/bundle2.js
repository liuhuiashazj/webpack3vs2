...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return funcA; });
function funcA(){
	console.log(funcA);
}
...
__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__a_js__["a" /* funcA */])();
function test(){
	console.log('liuhui');
}
function test2(){
